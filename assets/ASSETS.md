...
|---|---|---|
| Dog sprites | Original corgi + shiba 6-frame run cycles, mixed randomly within a Pack; sprites face right, flip for leftward Dogs | `dog-sprite/created/{shiba,corgi}/frame1-6.png` (+ sheets, previews); regenerate via `generate.py` |
